#ifndef SWAN_COL_WRAPPER_HPP
#define SWAN_COL_WRAPPER_HPP
...
struct ColWrapper {
	...
	ColWrapper(vec3 point) : type(COL_POINT), point(point) {}
	...
	ColWrapper& operator=(vec3 point) {
		type        = COL_POINT;
		this->point = point;
		return *this;
	}
	ColWrapper& operator=(Ray ray) {
		type      = COL_RAY;
		this->ray = ray;
		return *this;
	}
	ColWrapper& operator=(Plane plane) {
		type        = COL_PLANE;
		this->plane = plane;
		return *this;
	}
	ColWrapper& operator=(AABB aabb) {
		type       = COL_AABB;
		this->aabb = aabb;
		return *this;
	}
	// ColWrapper& operator=(BoundingSphere s) { type = COL_SPHERE; this->sphere
	// =
	// s;    return *this; }
