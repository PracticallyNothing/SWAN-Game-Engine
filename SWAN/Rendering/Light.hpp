...
namespace SWAN {
	...
	Light& operator=(DirectionalLight dl) { type = L_DIRECTIONAL; dirLight = dl; return *this; }
	Light& operator=(PointLight pl) { type = L_POINT; pointLight = pl; return *this; }
	Light& operator=(Spotlight sl) { type = L_SPOT; spotLight = sl; return *this; }
