...
namespace SWAN {
	...
	spriteShader.use();
	spriteShader.setUniformData("overrideColorInfluence", 1.0);
	spriteShader.setUniformData("overrideColor", color);
	spriteShader.setUniformData("overrideAlphaInfluence", alpha < 0 ? 0 : 1);
	spriteShader.setUniformData("overrideAlpha", alpha);
	source->bind();
	spriteVAO.draw(4, GL_TRIANGLE_FAN);
	spriteShader.unuse();
    }
