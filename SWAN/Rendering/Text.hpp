...
namespace SWAN {
	...
	Text& operator=(const std::string& txt) { if(text != txt) { text = txt; updateVAO(); } return *this; }
	Text& operator=(const char* const  txt) { if(text != txt) { text = txt; updateVAO(); } return *this; }
