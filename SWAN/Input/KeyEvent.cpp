...
namespace SWAN
{
	...
	std::string GetKeyName(Key k)
	{
		...
		if(k.Code != LShift && k.LShiftHeld)
			modifiers += "LShift + ";
		if(k.Code != RShift && k.RShiftHeld)
			modifiers += "RShift + ";
		if(k.Code != LCtrl && k.LCtrlHeld)
			modifiers += "LCtrl + ";
		if(k.Code != RCtrl && k.RCtrlHeld)
			modifiers += "RCtrl + ";
		if(k.Code != LAlt && k.LAltHeld)
			modifiers += "LAlt + ";
		if(k.Code != RAlt && k.RAltHeld)
			modifiers += "RAlt + ";
