...
Collision ColWrapper::checkCollision(const ColWrapper& other){
	...
	switch(type) {
		case COL_POINT:
			switch(other.type){
				case COL_POINT:  return Collision { point == other.point; glm::length(point - other.point) };
				case COL_LINE:   return Collision {};
				case COL_RAY:    return Collision {};
				case COL_AABB:   return CheckCollision(point, other.aabb);
				//case COL_SPHERE: return CheckCollision(point, other.sphere);
			}
			break;
		case COL_RAY:
			switch(other.type){
				...
				case COL_LINE:   return Collision {};
				case COL_RAY:    return Collision {};
				case COL_AABB:   return CheckCollision(line, other.aabb);
				//case COL_SPHERE: return CheckCollision(line, other.sphere);
			}
			break;
	}
	*/
