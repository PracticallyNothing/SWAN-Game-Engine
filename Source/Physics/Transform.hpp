...
namespace SWAN {
struct Transform {
	Transform(glm::vec3 _pos = glm::vec3(0), glm::vec3 _rot = glm::vec3(0),
	          glm::vec3 _scale = glm::vec3(1), Transform* _parent = NULL)
	...
	glm::mat4 getModel() const {
		...
		glm::mat4 parentMat =
		    (parent == NULL ? glm::mat4(1.0f) : parent->getModel());
	...
	glm::vec3 getForw() const {
		return glm::vec3(glm::vec4(0, 0, 1, 0) * getRotMat());
	}
	glm::vec3 getUp() const {
		return glm::vec3(glm::vec4(0, 1, 0, 0) * getRotMat());
	}
