...
namespace Util {
	...
	class Radians {
	  public:
		explicit constexpr Radians (double value = 0.0)
		  : v (value) {}
	...
	class Degrees {
	  public:
		explicit constexpr Degrees (double value = 0.0)
		  : v (value) {}
		explicit constexpr Degrees (Radians rad)
		  : v ((double) rad * 180 / M_PI) {}
	...
	constexpr Radians::Radians (Degrees deg)
	  : v ((double) deg * M_PI / 180.0) {}
