...
XML
SWAN::Util::ReadXML (string filename) {
	XML res;
...
vector<const XMLTag*>
XMLTag::findTagsWithName (string name) const {
...
void
XMLTag::findTagsWithName (const string&          name,
...
std::string
SWAN::Util::Stringify (const XML& xml) {
	stringstream ss;
	ss << std::boolalpha;
...
std::string
SWAN::Util::Stringify (const XMLTag& tag, int indent) {
	stringstream ss;
