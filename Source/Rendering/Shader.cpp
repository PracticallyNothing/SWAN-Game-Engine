...
void
Shader::compileShaders (const std::string& vertexShaderFilePath,
...
// linking.
void
Shader::addAttrib (const std::string& attributeName) {
...
void
Shader::compileShader (const std::string& filePath, GLuint id) {
	// Open the file
...
bool
Shader::hasUniform (const std::string& name) {
...
GLint
Shader::getUniformID (const std::string& name) { return uniforms[name]; }

void
Shader::setUniformData (const std::string& name, int data) {
	if (hasUniform (name))
		glUniform1i (uniforms[name], data);
}

void
Shader::setUniformData (const std::string& name, float data) {
	if (hasUniform (name))
		glUniform1f (uniforms[name], data);
}

void
Shader::setUniformData (const std::string& name, double data) {
	if (hasUniform (name))
		glUniform1f (uniforms[name], data);
}

void
Shader::setUniformData (const std::string& name, glm::vec2 data) {
	if (hasUniform (name))
		glUniform2f (uniforms[name], data.x, data.y);
}

void
Shader::setUniformData (const std::string& name, glm::vec3 data) {
	if (hasUniform (name))
		glUniform3f (uniforms[name], data.x, data.y, data.z);
}

void
Shader::setUniformData (const std::string& name, glm::vec4 data) {
	if (hasUniform (name))
		glUniform4f (uniforms[name], data.x, data.y, data.z, data.w);
}

void
Shader::setUniformData (const std::string& name,
                        glm::mat2&         data,
...
void
Shader::setUniformData (const std::string& name, Transform& data) {
	if (hasUniform (name)) {
...
void
Shader::setUniformData (const std::string& name, bool data) {
	if (hasUniform (name))
...
void
Shader::setUniformData (const std::string& name, DirectionalLight light) {
...
void
Shader::setUniformData (const std::string& name, PointLight light) {
...
void
Shader::setUniformData (const std::string& name, Spotlight light) {
	setUniformData (name + ".pos", light.position);
	setUniformData (name + ".dir", light.direction);
...
void
Shader::setUniform (ShaderUniform su) {
	if (!used && !lockUse)
		use ();
