...
namespace SWAN {
	...
	inline EventListener CreateTimer (typename Clock::duration time, EventListener::ActionFuncT action, bool runOnce = true) {
	...
	inline EventListener CreateRepeatingTimer (typename Clock::duration time, EventListener::ActionFuncT action) {
